...
from llmlab.pricing import FALLBACK_PRICING
from llmlab.scope import analyze_heuristic
from llmlab.tracker import get_session_summary, log_call
...
def test_concurrent_tracking(db_path, monkeypatch):
    ...
    monkeypatch.setattr("llmlab.tracker._find_project", lambda: proj)

    import llmlab.tracker as mod
